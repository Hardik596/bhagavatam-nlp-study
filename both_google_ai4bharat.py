...
# Initialize AI4Bharat Translation Model
en_san_ckpt = "ai4bharat/indictrans2-en-indic-1B"
en_san_tokenizer = AutoTokenizer.from_pretrained(en_san_ckpt, trust_remote_code=True)
en_san_model = AutoModelForSeq2SeqLM.from_pretrained(en_san_ckpt, trust_remote_code=True, low_cpu_mem_usage=True)
en_san_model.eval()
...
def batch_translate(input_sentences, src_lang, tgt_lang, model, tokenizer, ip):
    ...
    for sentence in input_sentences:
        processed_text = ip.preprocess(sentence, src_lang=src_lang, tgt_lang=tgt_lang)
        ...
        translations.append(ip.postprocess(translated_text, lang=tgt_lang))
    return translations
...
sanskrit_sentence = "प्रिये मातः देवकी तव गर्भान्तरे देवस्य परमं व्यक्तित्वम्"
...
# Step 3️⃣: Translate Back to Sanskrit using AI4Bharat
src_lang, tgt_lang = "eng_Latn", "san_Deva"
sanskrit_lemmas = batch_translate(lemmas, src_lang, tgt_lang, en_san_model, en_san_tokenizer, ip)
